...
const context = async({ req }) => {
  ...
  if (
    req.body.operationName === 'signup' || req.body.operationName === 'Query' ||
    req.body.operationName === 'Login' || req.body.operationName === 'Stations' || req.body.operationName === 'StationHistory' 
  ) {
    return {};
  }
